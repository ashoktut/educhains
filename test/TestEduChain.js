...
const truffleAssert = require('truffle-assertions') // This package needs to be installed prior to testing

contract('EduChain', function(accounts) {
    // Declare a few constants and assign a few sample accounts generated by ganache-cli
    var sku = 1
    var upc = 1
    ...
    it("Testing smart contract function admit() that allows a university to admit a student", async() => {
        ...
        // Watch the emitted event Admitted()
        ...
        // Retrieve the just now saved item from blockchain by calling function fetchPersonBuffertwo()
        const resultBufferTwo = await eduChain.fetchPersonBufferTwo.call(upc)
    ...
    it("Testing smart contract function register() that allows a student to register for course", async() => {
        ...
        // Watch the emitted event Registered()
        ...
        // Retrieve the just now saved person from blockchain by calling function fetchPersonBufferTwo()
        const resultBufferTwo = await eduChain.fetchPersonBufferTwo.call(upc)
    ...
    it("Testing smart contract function apply_accommodation() that allows a student to apply for accommodation", async() => {
        ...
        // Watch the emitted event Applied_Accommodation()
    ...
    it("Testing smart contract function accepted_accommodation() that allows Accommodation to accept a Student", async() => {
        ...
        // Watch the emitted event Accepted()
    ...
    it("Testing smart contract function apply_nsfas() that allows a student to apply for NSFAS FUNDING", async() => {
        ...
        // Watch the emitted event Applied_Nsfas()
    ...
    // 7th test
    it("Testing smart contract function approved_nsfas() that allows NSFAS to Approve a Student for Funding ", async() => {
        const eduChain = await EduChain.deployed()
        ...
        // Mark a student as Approved by calling function approved_nsfas()
    ...
    it("Testing smart contract function reqBookFund() that allows a student to request for book funds from nsfas", async() => {
        ...
        // Verify the result set
        assert.equal(resultBufferTwo[3], bookPrice, "Error: Invalid Book Fund Amount")
    ...
    it("Testing smart contract function reqMonthlyFund() that allows a student to request for monthly funds from nsfas", async() => {
        ...
        // Watch the emitted event Requested_MonthlyFunds()
        eduChain.Requested_MonthlyFunds(null, (error, event)=> {
            eventEmitted = true
        })

        // Mark a student as requested monthly funds by calling the function reqMonthlyFund()
        ...
        // Verify the result set
        assert.equal(resultBufferTwo[4], montlhyPrice, "Error: Invalid Monthly Fund Amount")
        assert.equal(resultBufferTwo[7], personState, 'Error: Invalid Person State')
    ...
    it("Testing smart contract function payMonthly() that allows nsfas to pay monthly funds to student", async() => {
        ...
        // Mark a student as Paid_Books by calling function payMonthly()
    ...
    it("Testing smart contract function reqRentFund() that allows rental place to request for rent from nsfas", async() => {
        ...
        // Watch the emitted event Requested_Rent()
        eduChain.Requested_Rent(null, (error, event)=> {
            eventEmitted = true
        })

        // Mark a student as requested rent funds by calling the function reqRentFund()
        ...
        // Verify the result set
        assert.equal(resultBufferTwo[5], rentPrice, "Error: Invalid Rent Amount")
        assert.equal(resultBufferTwo[7], personState, 'Error: Invalid Person State')
    ...
    it("Testing smart contract function payRent() that allows nsfas to pay monthly funds to student", async() => {
        ...
        // Watch the emitted event Paid_Rent()
        eduChain.Paid_Rent(null, (error, event)=>{
            eventEmitted = true
        })

        // Mark a student as Paid_Rent by calling function payRent()
    ...
    it("Testing smart contract function reqFeesFund() that allows university to request fees from nsfas", async() => {
        ...
        // Verify the result set
        assert.equal(resultBufferTwo[6], feesPrice, "Error: Invalid Rent Amount")
        assert.equal(resultBufferTwo[7], personState, 'Error: Invalid Person State')
    ...
    it("Testing smart contract function payFees() that allows nsfas to pay fees to university", async() => {
        ...
        // Mark a student as Paid_Fees by calling function payBooks()
        ...
        assert.equal(resultBufferTwo[10], nsfasID, "Error: Invalid Nsfas ID.")
        assert.equal(resultBufferTwo[7], personState, 'Error: Invalid Person State')
        truffleAssert.eventEmitted(result, 'Paid_Fees');
    })
